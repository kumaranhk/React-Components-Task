...
const Nav = ({ type }) => {
    let links = ["About", "Conatct", "Terms of use", "Privacy policy"];
    if (type === "header") {
        return (
            <>
        ...
        return (
            <>
                <footer className="footer bg-light" style={{ height: "15vh", display: "flex", alignItems: "center" }}>
                    <div className="container">
                        <div className="row">
                                ...
                                <ul className="list-inline mb-2">
                                    {links.map((val, index) => (
                                        <React.Fragment key={index}>
                                            <li className="list-inline-item"><a href="#!">{val}</a></li>
                                            {index + 1 !== links.length && (<li className="list-inline-item">⋅</li>)}
                                        </React.Fragment>
                                    ))}
                                </ul>
